...
function FaqBody() {
  const questions = [
    {
      id: 0,
      question: '누가 연구자로 프로젝트를 시작할 수 있나요?',
      answer:
    ...
    {
      id: 1,
      question: '좀 더 구체적인 프로젝트 심사기준 및 방법이 궁금합니다!',
      answer:
